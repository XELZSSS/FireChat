...
const createAppBridge = ({ ipcRenderer, channels }) => ({
  ...
  getCliProviderStatus: invoke(ipcRenderer, channels.app.getCliProviderStatus),
  syncCliProviderConfig: invoke(ipcRenderer, channels.app.syncCliProviderConfig),
  runCliPrompt: invoke(ipcRenderer, channels.app.runCliPrompt),
  stopCliProvider: invoke(ipcRenderer, channels.app.stopCliProvider),
  cleanupCliSessions: invoke(ipcRenderer, channels.app.cleanupCliSessions),
