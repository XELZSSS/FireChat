...
export const ImageGenerationDeepInfraSection = ({
  capabilities,
  disabled,
  imageGeneration,
  onUpdate,
    ...
    <Field label={t('settings.imageGeneration.deepInfra.title')}>
      <SettingsCard className="grid gap-4 md:grid-cols-2">
        ...
        <NumberSetting
          ...
          setting="deepInfraGuidanceScale"
          min={0}
          max={30}
          step={0.1}
          imageGeneration={imageGeneration}
        ...
        <TextSetting
          ...
          setting="deepInfraNegativePrompt"
          imageGeneration={imageGeneration}
          onUpdate={onUpdate}
          disabled={disabled}
        />
